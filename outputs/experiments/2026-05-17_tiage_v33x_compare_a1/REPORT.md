...
> 수치는 `2026-05-17_tiage_v33x_compare` 와 동일 (method-deterministic,
> std=0.000). 본 a1 은 재현 확인용 중복 run 으로, 동일 수치를 중복
> 연산하지 않기 위해 compare 결과를 그대로 재사용했다 (ARI/Pk/WD
> 포함, ms/turn 도 compare 측정값). 2026-05-17 ARI 반영 갱신.
