...
|---|---:|---:|---:|---:|
| tiage | 468 | 22.80 / 21.57 / 29.41 | 0.2143 / 0.1993 / 0.2572 | 23.02 / 21.76 / 29.62 |
| dialseg711 | 498 | 27.17 / 23.13 / 34.70 | 0.2445 / 0.2032 / 0.2811 | 27.41 / 23.33 / 34.96 |
| superseg | 468 | 25.18 / 22.95 / 35.99 | 0.2236 / 0.2005 / 0.2591 | 25.41 / 23.14 / 36.21 |

## 3. cross-benchmark 평균 (Ours 행에 단일 latency 보고용)

- **Pre. (encode)**: mean = 25.10 ms · p50 22.44 · p90 33.30 (n=1434)
- **Seg. (assign)**: mean = 0.2278 ms · p50 0.2011 · p90 0.2661
- **Total (Pre.+Seg.)**: mean = 25.32 ms · p50 22.66 · p90 33.50
- cold-start (model load): 27.77 s — per-turn 과 분리.

## 4. 표 셀 매핑 (dts_result.md 의 Online Ours 4 행)

- **Pre.** 셀 = 25 ms (cross-bench mean, encoder single-utt forward).
- **Seg.** 셀 = 0.228 ms (cross-bench mean, HiOnTop.assign).
