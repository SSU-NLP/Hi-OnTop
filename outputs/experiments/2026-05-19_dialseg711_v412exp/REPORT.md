...
| v4.1.1 @TIAGE-cfg(m2,ρ0.7,a0.5,δ*0.5594) (zero-shot) | 0.590 | 0.549 | 0.325 | 0.415 | 0.269 | 711 |
| v4.1.1 @oracle-δ*=0.613 (upper bound) | 0.629 | 0.560 | 0.285 | 0.319 | 0.154 | 711 |
| v4.1.2-exp(per-topic δ*) @TIAGE-cfg δ*0.5594 (zero-shot) | 0.589 | 0.549 | 0.325 | 0.416 | 0.270 | 711 |
