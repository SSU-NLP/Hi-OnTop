#!/usr/bin/env python3
"""Hi-OnTop p70/p75/p80 per-metric for MiniLM-int8 (3 benches).
...
def main() -> None:
    out_dir = REPO / "outputs" / "experiments" / "2026-05-24_hiontop_minilm_int8_percentile"
    ...
    L = ["# Hi-OnTop p70/p75/p80 per-metric (MiniLM-int8, superdialseg_data)",
         "",
